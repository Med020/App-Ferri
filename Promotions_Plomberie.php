...
$query = "SELECT files.code, files.titre, files.picture_url, files.file_path
          ...
          WHERE produit_recherche.promotion = 1
          AND produit_recherche.departement = 'PLOMBERIE'
          OR produit_recherche.promotion = 1
          AND produit_recherche.departement = 'SANITAIRE' ";
