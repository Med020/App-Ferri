...
class NProductScreenO extends StatefulWidget {
  final int id;
  const NProductScreenO({Key? key, required this.id}) : super(key: key);

  @override
  State<NProductScreenO> createState() => _NProductScreenStateO();
}

class _NProductScreenStateO extends State<NProductScreenO> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.1.6/app_ferri/Nouveaute_Outillage.php'));
