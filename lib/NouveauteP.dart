...
class NProductScreenP extends StatefulWidget {
  final int id;
  const NProductScreenP({Key? key, required this.id}) : super(key: key);

  @override
  State<NProductScreenP> createState() => _NProductScreenStateP();
}

class _NProductScreenStateP extends State<NProductScreenP> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.1.6/app_ferri/Nouveaute_Plomberie.php'));
