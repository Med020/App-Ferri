...
class CTarifScreenG extends StatefulWidget {
  final int id;
  const CTarifScreenG({Key? key, required this.id}) : super(key: key);

  @override
  State<CTarifScreenG> createState() => _CTarifScreenStateG();
}

class _CTarifScreenStateG extends State<CTarifScreenG> {
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(builder: (context) => EntryPointC(id: id)),
              );
            },
          ),
        ),
