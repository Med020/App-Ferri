...
class TarifScreenM extends StatefulWidget {
  final int id;
  const TarifScreenM({Key? key, required this.id}) : super(key: key);

  @override
  State<TarifScreenM> createState() => _TarifScreenStateM();
}

class _TarifScreenStateM extends State<TarifScreenM> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.6/app_ferri/Tarifs_Maison.php'));
