...
class NProductScreenM extends StatefulWidget {
  final int id;
  const NProductScreenM({Key? key, required this.id}) : super(key: key);

  @override
  State<NProductScreenM> createState() => _NProductScreenStateM();
}

class _NProductScreenStateM extends State<NProductScreenM> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.6/app_ferri/Nouveaute_Maison.php'));
