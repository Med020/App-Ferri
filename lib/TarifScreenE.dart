...
class TarifScreenE extends StatefulWidget {
  final int id;
  const TarifScreenE({Key? key, required this.id}) : super(key: key);

  @override
  State<TarifScreenE> createState() => _TarifScreenStateE();
}

class _TarifScreenStateE extends State<TarifScreenE> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.1.6/app_ferri/Tarifs_Electricite.php'));
