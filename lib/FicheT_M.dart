...
class FProductScreenM extends StatefulWidget {
  final int id;
  const FProductScreenM({Key? key, required this.id}) : super(key: key);

  @override
  State<FProductScreenM> createState() => _FProductScreenStateM();
}

class _FProductScreenStateM extends State<FProductScreenM> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.1.6/app_ferri/FichesTechnique_maison.php'));
