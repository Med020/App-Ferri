...
class TarifScreenO extends StatefulWidget {
  final int id;
  const TarifScreenO({Key? key, required this.id}) : super(key: key);

  @override
  State<TarifScreenO> createState() => _TarifScreenStateO();
}

class _TarifScreenStateO extends State<TarifScreenO> {
