...
class FProductScreenO extends StatefulWidget {
  final int id;
  const FProductScreenO({Key? key, required this.id}) : super(key: key);

  @override
  State<FProductScreenO> createState() => _FProductScreenStateO();
}

class _FProductScreenStateO extends State<FProductScreenO> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(Uri.parse(
          'http://192.168.1.6/app_ferri/FichesTechnique_Outillage.php'));
