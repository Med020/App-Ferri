...
class CTarifScreenE extends StatefulWidget {
  final int id;
  const CTarifScreenE({Key? key, required this.id}) : super(key: key);

  @override
  State<CTarifScreenE> createState() => _CTarifScreenStateE();
}

class _CTarifScreenStateE extends State<CTarifScreenE> {
