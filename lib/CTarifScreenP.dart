...
class CTarifScreenP extends StatefulWidget {
  final int id;
  const CTarifScreenP({Key? key, required this.id}) : super(key: key);
  @override
  State<CTarifScreenP> createState() => _CTarifScreenStateP();
}

class _CTarifScreenStateP extends State<CTarifScreenP> {
