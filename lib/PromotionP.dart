...
class PProductScreenP extends StatefulWidget {
  final int id;
  const PProductScreenP({Key? key, required this.id}) : super(key: key);

  @override
  State<PProductScreenP> createState() => _PProductScreenStateP();
}

class _PProductScreenStateP extends State<PProductScreenP> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.1.6/app_ferri/Promotions_Plomberie.php'));
