...
class CTarifScreenM extends StatefulWidget {
  final int id;
  const CTarifScreenM({Key? key, required this.id}) : super(key: key);
  @override
  State<CTarifScreenM> createState() => _CTarifScreenStateM();
}

class _CTarifScreenStateM extends State<CTarifScreenM> {
