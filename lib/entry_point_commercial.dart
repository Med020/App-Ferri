...
import 'CTarifScreenE.dart';
import 'CTarifScreenGlobal.dart';
import 'CTarifScreenM.dart';
import 'CTarifScreenO.dart';
import 'CTarifScreenP.dart';
...
class EntryPointC extends StatelessWidget {
  final int id;
  const EntryPointC({Key? key, required this.id}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: EntryPointCPage(id: id),
    );
  }
}

class EntryPointCPage extends StatefulWidget {
  final int id;
  const EntryPointCPage({Key? key, required this.id}) : super(key: key);

  @override
  _EntryPointCPageState createState() => _EntryPointCPageState();
}

class _EntryPointCPageState extends State<EntryPointCPage> {
              ...
              children: [
                ...
                ArrowList(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) => CTarifScreenM(id: id)),
                    );
                    print('Maison ');
                  },
                ),
                ArrowList(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) => CTarifScreenE(id: id)),
                    );
                    print('Electricite ');
                  },
                ),
                ArrowList(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) => CTarifScreenP(id: id)),
                    );
                    print('P et S ');
                  },
                ),
                ArrowList(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) => CTarifScreenO(id: id)),
                    );
                    print('Q et O ');
                  },
                ),
                ArrowList(
                  ...
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) => CTarifScreenG(id: id)),
                    );
                    print('Q et O ');
                  },
                ),
