...
class TarifScreenP extends StatefulWidget {
  final int id;
  const TarifScreenP({Key? key, required this.id}) : super(key: key);

  @override
  State<TarifScreenP> createState() => _TarifScreenStateP();
}

class _TarifScreenStateP extends State<TarifScreenP> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.6/app_ferri/Tarifs_Plomberie.php'));
