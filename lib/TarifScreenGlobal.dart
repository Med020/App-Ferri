import 'package:espace_client/entry_point_gerant.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'Produit.dart';

class TarifScreenG extends StatefulWidget {
  final int id;
  const TarifScreenG({Key? key, required this.id}) : super(key: key);

  @override
  State<TarifScreenG> createState() => _TarifScreenStateG();
}

class _TarifScreenStateG extends State<TarifScreenG> {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.6/app_ferri/Tarif_global.php'));
