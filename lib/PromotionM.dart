...
class PProductScreenM extends StatefulWidget {
  final int id;
  const PProductScreenM({Key? key, required this.id}) : super(key: key);

  @override
  State<PProductScreenM> createState() => _PProductScreenStateM();
}

class _PProductScreenStateM extends State<PProductScreenM> {
  List<Cadre> cadres = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http
          .get(Uri.parse('http://192.168.1.6/app_ferri/Promotions_Maison.php'));
